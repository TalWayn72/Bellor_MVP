...
## 🔄 TASK-001: File Size Enforcement - 150 Line Maximum (7 פברואר 2026)

**סטטוס:** 🔄 בביצוע
**חומרה:** 🟢 שיפור
**תאריך:** 7 פברואר 2026

**תיאור:** אכיפת מגבלת 150 שורות מקסימום לכל קובץ קוד מקור. פיצול ~80 קבצים גדולים ל-~180 קבצים קטנים יותר.

**התקדמות:**
| Batch | תיאור | קבצים | סטטוס |
|-------|--------|--------|--------|
| 0 | Update rules (CLAUDE.md, OPEN_ISSUES.md) | 2 | ✅ הושלם |
| 1 | Largest files (1,897-653 lines) | 5 | ⏳ ממתין |
| 2 | Large backend (587-532 lines) | 5 | ⏳ ממתין |
| 3 | Frontend pages (400-512 lines) | 5 | ⏳ ממתין |
| 4 | Frontend 350-400 + services | 10 | ⏳ ממתין |
| 5 | Backend 300-467 lines | 12 | ⏳ ממתין |
| 6 | Frontend 230-291 lines | 9 | ⏳ ממתין |
| 7 | Backend 200-270 + Frontend 200-235 | 21 | ⏳ ממתין |
| 8 | Borderline files 150-215 lines | ~20 | ⏳ ממתין |
