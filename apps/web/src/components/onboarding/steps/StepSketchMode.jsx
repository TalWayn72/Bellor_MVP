    ...
    <div className="min-h-screen flex flex-col bg-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 relative z-10">
        <div className="w-full max-w-md">
          <h2 className="text-xl font-bold text-center mb-6 text-white drop-shadow-lg">Choose your Sketch Mode</h2>

          <ProgressBar currentStep={9} totalSteps={TOTAL_STEPS} />

          <div className="bg-white rounded-3xl p-5 shadow-lg">
            <h3 className="text-base font-bold mb-3 text-gray-900">Draw Your Choice</h3>
            <p className="text-xs text-gray-500 mb-4">Express your choice in a simple sketch</p>
