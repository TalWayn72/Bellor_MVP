          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="space-y-2">
              <div className="flex gap-3">
                <select value={formData.location} onChange={(e) => setFormData({ ...formData, location: e.target.value, location_city: '' })} className="flex-1 h-12 text-base bg-card text-card-foreground border-2 border-gray-300 rounded-lg px-3">
              ...
              <select value={formData.location_city} onChange={(e) => setFormData({ ...formData, location_city: e.target.value })} className="w-full h-12 text-base bg-card text-card-foreground border-2 border-gray-300 rounded-lg px-3">
